...
class Biker implements Runnable {
    ...
    public Biker(String name, int speed, int raceDistance, CountDownLatch startLatch, CountDownLatch endLatch) {
        this.name = name;
        this.speed = speed;
...
public class BikeRaceAssignment {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        CountDownLatch endLatch = new CountDownLatch(numBikers);
        ...
        for (int i = 0; i < numBikers; i++) {
            ...
            Biker biker = new Biker(name, speed, raceDistance, startLatch, endLatch);
            bikers.add(biker);
