...
public class StudentService {
	...
	public String getClassTeacher(int reg_no) {
		if(dao.existsById(reg_no)) {
			int standard = dao.findById(reg_no).get().getStandard();
			return ts.getTeacherByStandard(standard);
		}
